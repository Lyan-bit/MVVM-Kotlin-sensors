...
class  AccelerometerClassificationViewModel (myContext: Context): ViewModel()  {
    ...
    companion object {
        private var instance: AccelerometerClassificationViewModel? = null
        fun getInstance(context: Context): AccelerometerClassificationViewModel {
            return instance ?: AccelerometerClassificationViewModel(context)
        }
    }
